...
class Cfp::PasswordsControllerTest < ActionController::TestCase
  ...
  test 'sends password reset instructions' do
    ...
    assert_difference 'ActionMailer::Base.deliveries.size' do
      post :create, params: { conference_acronym: @conference.acronym, user: { email: user.email } }
    end
  ...
  test 'displays password reset form' do
    ...
    get :edit, params: { conference_acronym: @conference.acronym, reset_password_token: user.reset_password_token }
    assert_response :success
  end
  ...
  test 'allows setting a new password' do
    ...
    put :update, params: { conference_acronym: @conference.acronym, user: { reset_password_token: user.reset_password_token, password: '123frab', password_confirmation: '123frab' } }
    assert_response :redirect
